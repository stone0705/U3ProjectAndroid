 ...
 */
public class AsyncApplyAction extends AsyncTask<String,Integer,Integer> {
    ...
    String response;
    Context mContext;
    public AsyncApplyAction(Context mContext){
    ...
    protected Integer doInBackground(String... params) {
        ...
        try{
            ...
            bw.write(StringRule.standard("1102",params[0],params[1],params[2],params[3]));
            bw.flush();
